package com.techcamps.gestao.cursos.spring;
...
@Configuration
@ComponentScan({ "com.techcamps.gestao.cursos" })
    ...
    public ServletContextInitializer initializer() {
        return new ServletContextInitializer() {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "com.techcamps.gestao.cursos");
                servletContext.setInitParameter("tapestry.development-modules", "com.techcamps.gestao.cursos.services.DevelopmentModule");
